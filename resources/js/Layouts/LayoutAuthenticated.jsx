                ...
                <div className="border-b border-gray-200">
                    ...
                    {sections.actions && (
                        <div className="py-2">
                            ...
                            <Link href="/items" className={menuItemClass}>
                                <svg width="20" height="20" fill="currentColor" viewBox="0 0 16 16" className="shrink-0">
                            ...
                            <Link href="/locations" className={menuItemClass}>
                                <svg width="20" height="20" fill="currentColor" viewBox="0 0 16 16" className="shrink-0">
                                ...
                                <span>Location's Management</span>
                            </Link>
                            
                            <Link href={route('dispense')} className={menuItemClass}>
                                <svg width="20" height="20" fill="currentColor" viewBox="0 0 16 16" className="shrink-0">
                            ...
                            <Link href={route('dispose')} className={menuItemClass}>
                                <svg width="20" height="20" fill="currentColor" viewBox="0 0 16 16" className="shrink-0">

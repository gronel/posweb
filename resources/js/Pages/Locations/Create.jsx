...
export default function LocationsCreate() {
    const form = useForm({ location: '', description: '' });
    ...
    return (
        <div className="p-6">
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    <h2 className="text-2xl font-bold mb-0.5">Add New Location</h2>
                    <p className="text-gray-500 text-sm">Create a new storage location for items.</p>
                </div>
            </div>
                    ...
                    <form onSubmit={submit} className="space-y-4">
                        ...
                        <div className="flex gap-3 pt-2">
                            <button type="submit" className="bg-gradient-to-r from-[#667eea] to-[#764ba2] text-white px-6 py-3 rounded-lg font-semibold hover:opacity-90 transition-opacity disabled:opacity-60" disabled={form.processing}>
                                {form.processing ? 'Saving...' : 'Create Location'}
                            </button>

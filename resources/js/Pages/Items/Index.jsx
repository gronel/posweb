    ...
    return (
        <div className="p-6">
            <div className="flex justify-between items-center mb-6">
                <div>
                    <h2 className="text-2xl font-bold mb-0.5">Item Master</h2>
                    <p className="text-gray-500 text-sm">Manage inventory items</p>
                </div>
                <Link href="/items/create" className="flex items-center gap-2 bg-gradient-to-r from-[#667eea] to-[#764ba2] text-white px-4 py-2.5 rounded-lg text-sm font-semibold hover:opacity-90 transition-opacity">
                        ...
                        <tbody className="divide-y divide-gray-100">
                            {items.data.map((item) => (
                                <tr key={item.id} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 text-gray-700">{item.itemcode}</td>
                                    ...
                                    <td className="px-6 py-4 text-right">
                                        <div className="inline-flex gap-2">
                                            ...
                                            <button onClick={() => deleteItem(item.id)} className="flex items-center gap-1 border border-red-300 text-red-600 px-3 py-1.5 rounded-lg text-xs hover:bg-red-50 transition-colors">
                                                <svg width="12" height="12" fill="currentColor" viewBox="0 0 16 16">

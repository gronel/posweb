...
export default function ItemsEdit({ item, locations, categories }) {
    const form = useForm({
        itemcode: item.itemcode || '',
        itemname: item.itemname || '',
        itemdescription: item.itemdescription || '',
        locationid: item.locationid || (locations.length ? locations[0].id : ''),
        itemcategoryid: item.itemcategoryid || (categories.length ? categories[0].id : ''),
    ...
    return (
        <div className="p-6">
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    <h2 className="text-2xl font-bold mb-0.5">Edit Item</h2>

<template>
  <div class="container-fluid">
          ...
          <table class="table table-hover mb-0">
            ...
            <tbody>
              ...
              <tr v-if="!suppliers.data.length">
                <td colspan="8" class="px-4 py-4 text-center text-muted">No suppliers found.</td>
              </tr>
            </tbody>
          </table>
        </div>
    ...
    <!-- Pagination -->
    <div v-if="suppliers.links && suppliers.links.length > 3" class="mt-4 d-flex justify-content-center">
      <nav>
        <ul class="pagination">
          <li v-for="(link, index) in suppliers.links" :key="index" class="page-item" :class="{ 'active': link.active, 'disabled': !link.url }">
